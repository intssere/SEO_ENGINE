...
export const P8_8_W06_COMPATIBLE_TABLE_COUNTS = Object.freeze([41, 43] as const);
  ...
  async readSnapshot(input: {
    ...
    try {
      return await sql.begin(async (tx) => {
        ...
        if (
          !P8_8_W06_COMPATIBLE_TABLE_COUNTS.includes(
...
export function p88W06SnapshotStoreCapability() {
  return Object.freeze({
    ...
    compatibleAdditivePublicTableCounts: P8_8_W06_COMPATIBLE_TABLE_COUNTS,
