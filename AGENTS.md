...
- Generic continuation into P11.8 may perform architecture/domain review of whether v1 commercial scope requires first-class multi-site/project abstraction, including existing org/site identity, tenant boundaries, switching UX, route/API scoping and migration implications. It does not authorize schema migration, live tenant provisioning, Production DB/storage mutation, data migration, provider/public-site activity, secret/runtime/deployment changes, scheduler/worker activation, P9.8 implementation/activation, Task #51/#53/#54 execution, deployment or publication.
