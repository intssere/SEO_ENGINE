...
- Issue #387 adds production-capable P12.2 network/persistence adapters and manual composition, but they remain default-off and unbound from startup/API/schedulers/workers. Exact site identity is `eb1da9ee-539c-4200-8f04-f64ccaea7768` / `https://diamondshelf.us`. A merged adapter does not itself authorize schema application, network access or persistence.
