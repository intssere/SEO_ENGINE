...
- Default next safe program boundary is **P11.9 — retention/privacy/provider terms and compliance review**, initially review/documentation only with no production deletion/migration, credential rotation, provider-account mutation, deployment or publication.
