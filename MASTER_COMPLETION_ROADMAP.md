...
| P8.8 | Progressive policy-authorized low-risk execution | W07 IMPLEMENTATION IN PROGRESS — specification certified through canonical `57d4fc640f876b958d3ad87eca8391b1849a00bb`; issue #471 implements W07-E1–E5 with policy-only two-phase dispatch fencing, additive migration 0007 source, exact W02 byte-preserving Shopify mutation/rollback adapters, one-forward/one-rollback maximum, independent verification, W04 safe terminal closure and 43-table localhost certification; Production migrations/DDL/DML, live provider writes, runtime activation, deployment/publication and W08–W10 remain blocked |
