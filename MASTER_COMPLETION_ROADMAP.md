...
| P9.5 | failure/retry/dead-letter/idempotency controls | NEXT SAFE BOUNDARY — deterministic/default-off failure/retry/dead-letter/idempotency architecture over existing P9.1–P9.4 supplied/proposed artifacts only; no live retry loop, durable queue/dead-letter store, worker, provider/crawl request, persistence or publication on generic continuation |
