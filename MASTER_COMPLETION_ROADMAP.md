...
| P12.2 | full-site crawl complete and repeatable | LIVE-ADAPTER ENGINEERING IN PROGRESS / LIVE PROOF BLOCKED — bridge issue #382 / PR #383 remains certified; issue #387 adds exact Diamond Shelf production-capable but default-off sitemap/robots/page/clock adapters, dedicated 0004 crawl-state schema source, lazy persistence and manual composition. Issue #387 PR/CI certification is pending; its migration is not authorized for Production. Replit Development was unintentionally advanced to 37 tables by an early local migration test while Production remains 34; reconciliation is separately gated. Real full-site + interruption/resume + repeat/reconciliation + incremental + persisted Production evidence proof remains separately authorized |
