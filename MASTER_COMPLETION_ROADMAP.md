...
| P12.2 | full-site crawl complete and repeatable | ENGINEERING BRIDGE COMPLETE / LIVE PROOF BLOCKED — issue #382 / PR #383 / merge `0981daad1da5737ac4a4ec04d97ad6cf6659057d`; Diamond Shelf-only injected/default-off sitemap+robots+page+persistence bridge preserves P2.1–P2.6 contracts; exact-head CI #674 + post-merge CI #675, 1,273 workspace tests, Chromium 111/111, typecheck/build green; still requires separately authorized real full-site + interruption/resume + repeat/reconciliation + incremental + persisted Production evidence proof |
