...
| P8.8 | Progressive policy-authorized low-risk execution | W09-A IMPLEMENTATION IN PR CERTIFICATION — W01–W08 engineering certified; W09 spec issue #487 / PR #490 merged as `409ca6e61011caeaabffefc11f503a05623135a4`; W09 E1–E5 issue #493 / PR #494 implements pure/default-off caller-supplied Stage 0 source/evaluation/session certification, exact W01 recomputation, replay/conflict fencing, exact-target P8.6 descriptive comparison, full rejection/control matrix and static zero-write checks; engineering head `c9f68168a63f74e3ee89b7c52c23b040b55ad334` passed CI #1021 before continuity-doc updates; final head still requires exact-head recertification and explicit merge authorization; W09-B Production evidence and W10 Stage 1 remain blocked |
...
| P12.2 | full-site crawl complete and repeatable | LIVE-ADAPTER ENGINEERING CERTIFIED / LIVE PROOF BLOCKED — bridge issue #382 / PR #383 and live-adapter issue #387 / PR #388 are certified. Adapter exact-head CI #686 and post-merge CI #687 passed; merge `cfdb21f3853f6a6c604686d750016c08c7f43492`, tree `317675fd81f3a83a0336be56c4e4c1f816ff82d9`; Replit exact Git-only sync 0/0 clean. Production remains 34 tables and migration 0004 is not applied there. Development is 37 only because of the disclosed early migration-test incident; no rollback was attempted. Real Production schema application + deployment/runtime activation + full-site + interruption/resume + repeat/reconciliation + incremental + persisted evidence proof remain separately authorized |
...
| P12.6 | governed execution/rollback certified | PARTIAL — P8.7 now supplies one real persistent governed Shopify execution with independent provider/storefront verification and closed-gate recovery; live rollback was not needed/exercised, P8.8 progressive policy execution remains, and broader production certification is still required |
