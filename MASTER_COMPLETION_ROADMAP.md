...
| P11.8 | multi-site/project abstraction if required for v1 commercial scope | NEXT SAFE REVIEW — determine whether first-class org/site/project abstraction is required before final commercial scope lock; no schema/data/runtime mutation on generic continuation |
