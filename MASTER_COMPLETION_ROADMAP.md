...
| P8.8 | Progressive policy-authorized low-risk execution | W04 ENGINEERING COMPLETE / PRODUCTION DDL + W05+ BLOCKED — W04 issue #418 / PR #419 certified and issue #420 / PR #422 implements deterministic reservation intent, unchanged-W03 precommit validation, additive migration 0005 source, dedicated PostgreSQL reservation store, exact replay/collision/site/target conflict handling, DB-clock expiry reconciliation, one-active-per-site/target constraints, bounded durable receipts, real concurrency certification and W03/W04 pairing; Production migration 0005 remains unapplied and separately gated; W05–W10 remain separately gated |
