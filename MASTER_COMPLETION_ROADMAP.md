...
| P8.8 | Progressive policy-authorized low-risk execution | W03 IMPLEMENTATION COMPLETE / W04+ BLOCKED — W01 pure admission + W02 deterministic materialization are certified; W03 issue #414 / PR #415 certifies and issue #416 / PR #417 implements pure provenance-distinct `policy_authorization` with canonical W01/W02 rebuild, exact cross-lineage equality, synthetic non-durable reservation binding, bounded TTL, artifact-only policy action identity and explicit no-dispatch/no-human-path semantics; W04–W10 remain separately gated |
