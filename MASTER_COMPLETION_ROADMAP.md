...
| P8.8 | Progressive policy-authorized low-risk execution | W05 ENGINEERING IMPLEMENTED / FINAL PR CERTIFICATION + PRODUCTION DDL + W06+ BLOCKED — W04 remains certified; W05 issue #443 / PR #444 implements durable control state/history, exact W03/W04 + control-revision claim binding, atomic `authorized -> claimed`, safe unclaimed release, latched kill and real PostgreSQL claim/control race certification; corrected code-only head `6f5e302db014c153cfca2f86ca7f46136e0ab74f` passed CI #825 completely; final PR-head CI/merge still pending; migrations 0005/0006 remain unapplied to Production and W06–W10 remain separately gated |
