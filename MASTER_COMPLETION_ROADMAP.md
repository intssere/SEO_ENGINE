...
| P8.8 | Progressive policy-authorized low-risk execution | W03 COMPLETE / W04 SPEC REVIEW ACTIVE — W03 pure `policy_authorization` is certified; W04 issue #418 defines a dedicated PostgreSQL `policy_mutation_reservations` namespace, deterministic W01/W02 reservation precommit bound through unchanged W03, exact replay/collision semantics, one-active-per-site/target constraints, DB-clock expiry reconciliation, bounded durable receipts and separate engineering/Production-DDL gates; W04 implementation and W05–W10 remain separately gated |
