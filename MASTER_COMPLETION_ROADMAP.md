...
| P6.4 | explanation/evidence generation | NEXT SAFE DEFAULT — deterministic/default-off evidence/explanation projection over certified P6.1/P6.2/P6.3 records; no live execution |
...
31. **DONE — P6.1/P6.2/P6.3:** unified opportunity classification/evidence, deterministic transparent scoring, and deterministic collection conflict/dedupe/suppression/prioritization are complete; P6.3 issue #249 / PR #250 / merge `06739367624018c501a11459881462e2be480657`.
