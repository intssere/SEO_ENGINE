...
| P11.9 | retention/privacy/provider terms and compliance review | NEXT SAFE REVIEW — inventory retention/deletion/privacy/credential/provider-term obligations and gaps; no production deletion/migration, secret rotation, provider-account mutation, deployment or publication on generic continuation |
